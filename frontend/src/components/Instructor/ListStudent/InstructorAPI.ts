...
export const studentAPI = {
    ...
    add: (data: any) => axios.post(`${API}/student/student`, data),
    update: (phone: string, data: any) => axios.patch(`${API}/student/edit-student/${phone}`, data),
    delete: (phone: string) => axios.delete(`${API}/student/deleteStudent/${phone}`),
    assignLesson: (payload: any) => axios.post(`${API}/student/lesson`, payload),
    ...
    assignLessionForClass:(data:any) => axios.post(`${API}/instructor/lession-for-class`,data),
    getListStudentToEnterScore:(data:any) => axios.get(`${API}/instructor/list-student-to-enter-score`,{params:data}),
    saveScore:(data:any) => axios.put(`${API}/instructor/score`,data),
}
